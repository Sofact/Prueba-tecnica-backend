...
public interface CuentaPersona extends JpaRepository<Persona, Long> {
    ...
    @Query(value = "SELECT c.cta_id, c.cta_estado, c.cta_numero, c.cta_saldo_inicial, c.cta_tipo_cuenta, c.per_id, p.per_nombre FROM pc.cuenta c INNER JOIN pc.persona p ON c.per_id = p.per_id", nativeQuery = true)
